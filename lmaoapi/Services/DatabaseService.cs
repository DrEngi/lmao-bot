...
namespace lmaoapi.Services
{
    public interface IDatabaseService
    {
        public Task<string> GetPrefix(long serverID);
        public Task UpdateUsageCount(string command);
        public Task UpdateLmaoCount(long userID);
        public Task<lmaocore.Models.ServerSettings.Server> GetServerSettings(long serverID);
        public Task<lmaocore.Models.UserSettings.UserSettings> GetUserSettings(long userID);
        public Task<int> ToggleAss(lmaocore.Models.ServerSettings.Server settings);
        public Task<int> SetAss(long serverID, int percent);
        public Task<int> SetReact(long serverID, int percent);
    }
